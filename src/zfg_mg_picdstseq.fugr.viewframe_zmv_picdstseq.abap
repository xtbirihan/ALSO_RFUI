*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZMV_PICDSTSEQ
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZMV_PICDSTSEQ       .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZMV_PICDSTSEQ'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZMV_PICDSTSEQ_EXTRACT
TOTAL = ZMV_PICDSTSEQ_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZMV_PICDSTSEQ'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZMV_PICDSTSEQ-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMV_PICDSTSEQ_EXTRACT
TOTAL = ZMV_PICDSTSEQ_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZMV_PICDSTSEQ-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZMV_PICDSTSEQ'
...
TOTAL = ZMV_PICDSTSEQ_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZMV_PICDSTSEQ-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZMV_PICDSTSEQ-UPD_FLAG NE SPACE.
